...
module.exports = function(req, next){
  ...
  var commands = ['h','b', 'd','e','a','r','v','V','p', 's', 'm', 'message', 'stage', 'endpoint','project','domain','add','remove','version','verbose','token','help','pem', 'promo', 'build', 'preview', 'web', 'manage', 'browser', '$0','_'];
