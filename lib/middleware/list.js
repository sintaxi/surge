        ...
        revisions.forEach(function(revision){
          if (revision.current){
            ...
            var row = [
              ...
              (revision.publicFileCount ? revision.publicFileCount.toString().underline.grey + " files".underline.grey : ""),
            ...
            var row = [
              ...
              revision.email.grey,
              (revision.publicFileCount ? revision.publicFileCount.toString().grey + " files".grey : ""),
