...
module.exports = function(req, next){
  if (req.argv.help || req.argv.h) {
    helpers
      ...
      .log()
      .log("  "+ req.configuration.name +" <path>   <domain>           "+"(opt --preview)".grey+"  publish project to domain".grey)
      ...
      .log("  "+ req.configuration.name +" status   <domain>                            "+"domain status and the one action if any".grey)
      ...
      .log("  "+ req.configuration.name +" dns      <domain>                            "+"view DNS records".grey)
      .log("  "+ req.configuration.name +" dns      <domain> add <type> <name> <value>  "+"add DNS record".grey)
      .log("  "+ req.configuration.name +" dns      <domain> rem <id>                   "+"remove DNS record".grey)
      .log("  "+ req.configuration.name +" whoami                                       "+"show who you are logged in as".grey)
      .log("  "+ req.configuration.name +" verify                                       "+"verify your email address".grey)
      ...
      .log("  "+ req.configuration.name +" token                                        "+"show token for automation purposes".grey)
      .log("  "+ req.configuration.name +" token add [--domain <domain>] [-m <msg>]     "+"mint token, optionally domain-scoped".grey)
      .log("  "+ req.configuration.name +" token rem <id>                               "+"remove a token".grey)
      .log("  "+ req.configuration.name +" tokens                                       "+"list tokens with usage".grey)
      .log("  "+ req.configuration.name +" plan                                         "+"upgrade or downgrade account plan".grey)
      .log("  "+ req.configuration.name +" plan --web                                   "+"upgrade in your browser".grey)
      .log("  "+ req.configuration.name +" plan --manage                                "+"manage plan, card & invoices in browser".grey)
