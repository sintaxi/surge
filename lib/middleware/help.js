...
// a domain (CNAME, package.json) the lines render against it, ready to run.

module.exports.dnsUsage = function(name, domain){
  var slot = domain || "[<domain>]"
  helpers
    .log()
...
module.exports.debugUsage = function(name, domain){
  var slot = domain || "[<domain>]"
  helpers
    .log()
...
module.exports.statsUsage = function(name, domain){
  var slot = domain || "[<domain>]"
  helpers
    .log()
