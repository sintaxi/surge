...
var auth = module.exports = function(req, next){
  ...
  var fetchToken = function(email, pass, callback){
    ...
    var urlParams = url.parse(req.argv.endpoint);
    var protocol = urlParams.protocol || "https:";
    var endpoint = urlParams.host || urlParams.pathname

    // Corner case no schema and localhost
    if (protocol !== "http:" && protocol !== "https:") {
      console.log("IN HERE")
      endpoint = urlParams.href;
      protocol = "http:";
    }
