...
module.exports = function(configuration){
  ...
  surge.dns = function(hooks){
    ...
    return function(){
      ...
      if (!a0) return help.dnsUsage(configuration.name, (discovery.local() || {}).domain)
  ...
  surge.debug = function(hooks){
    ...
    return function(){
      ...
      if (verb === null) return help.debugUsage(configuration.name, (discovery.local() || {}).domain)
  ...
  surge.stats = function(hooks){
    ...
    return function(){
      ...
      if (verb === null) return help.statsUsage(configuration.name, (discovery.local() || {}).domain)
      return surge[verb](hooks || {})(argv)
    }
  }

  // account namespace - whoami•login•logout•verify•card•nuke, bare = usage
