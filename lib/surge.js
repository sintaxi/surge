...
var current         = require("./middleware/current")
...
module.exports = function(configuration){
  ...
  surge.publish = function(hooks){
    ...
    var onion = [
      ...
      preDomain, discovery.setDomainFromCname, discovery.suggestDomainFromGenerator, protocol, domain, postDomain,
